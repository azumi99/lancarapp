...
const HeaderComponent: React.FC<IconItem> = ({ handleLeft, handleRight, title, iconLeft, iconRight, boorderless, roundedIconLeft, roundedIconRight, styleLeft, styleRight }) => {
